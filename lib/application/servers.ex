defmodule Elidactyl.Application.Servers do
  ...
  @spec update_server_details(Elidactyl.id, Elidactyl.params) :: {:ok, Server} | {:error, Error.t}
  ...
  @spec update_server_build_info(Elidactyl.id, Elidactyl.params) :: {:ok, Server.t} | {:error, Error.t}
  ...
  @spec update_server_startup(Elidactyl.id, Elidactyl.params) :: {:ok, Server.t} | {:error, Error.t}
